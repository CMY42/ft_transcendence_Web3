		...
		<footer class="footer container-fluid">
			<div class="row flex-column flex-md-row justify-content-between align-items-center text-center text-md-start mx-3">
				...
				<div class="col-md-auto my-2 small" id="language_selector_container">
					<a href="#" class="d-block text-decoration-none text-white">English</a>
					<a href="#" class="d-block text-decoration-none text-white mt-2">Français</a>
					<a href="#" class="d-block text-decoration-none text-white mt-2">Español</a>
					<a href="#" class="d-block text-decoration-none text-white mt-2">Български</a>
				</div>
